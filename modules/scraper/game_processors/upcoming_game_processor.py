...
def process_upcoming_game(
    ...
    """Process an upcoming game and add it to game_times."""
    ...
    try:
        ...
        game_times[f"{exact_matchup}_{unique_game_id}"] = time_info
        game_times[f"{exact_matchup_reverse}_{unique_game_id}"] = time_info
